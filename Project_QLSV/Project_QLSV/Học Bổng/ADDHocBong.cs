...
{
    public partial class ADDHocBong : Form
    {
        SqlConnection conn = new SqlConnection("Data Source=1R0NY;Initial Catalog=72dctm22;Integrated Security=True");
        string msv;
        public ADDHocBong(string msv)
        {
            InitializeComponent();
            this.msv = msv;
        }

        private void ADDHocBong_Load(object sender, EventArgs e)
        {
            Load_cbHB();
            Load_cbNam();
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "ADDHocBong"; // gọi đến proce AddKyLuat
        ...
        private void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                    ...
                    {
                        var r = new Database().Select("CheckSVHB '" + check + "'");
